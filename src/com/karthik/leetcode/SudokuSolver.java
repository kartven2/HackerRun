...
public class SudokuSolver {
    ...
    public static void main(String... args) {
        ...
        char[] b = "7........".toCharArray();
        char[] c = ".2.1.9...".toCharArray();
        char[] d = "..7...24.".toCharArray();
        char[] e = ".64.1.59.".toCharArray();
        char[] f = ".98...3..".toCharArray();
        char[] g = "...8.3.2.".toCharArray();
        char[] h = "........6".toCharArray();
        char[] i = "...2759..".toCharArray();
